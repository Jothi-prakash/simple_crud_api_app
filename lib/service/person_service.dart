...
Future<List<Persondetails>> getPersonDetails() async {
  var response = await dio
      .get('https://crudcrud.com/api/5a3e20ac44dd4101a76d970738ff346c/users');
...
Future<bool>deletePersonDetails(Persondetails personObj) async{
  var url=
  ('https://crudcrud.com/api/5a3e20ac44dd4101a76d970738ff346c/users/${personObj.id}');
...
Future<bool> addPersonDetails(Persondetails personObj) async {
  dio.options.contentType = 'application/json';
   var url=('https://crudcrud.com/api/5a3e20ac44dd4101a76d970738ff346c/users');
